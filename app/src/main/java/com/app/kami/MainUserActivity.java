...
public class MainUserActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null){
            adminId = extras.getInt("admin_id");
        }
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        ListView listView;
        RetrieveListingTask mListingTask = null;
        /**
        ...
        public class RetrieveListingTask extends AsyncTask<Void, Void, String> {
            JSONParser jsonParser = new JSONParser();
            private static final String login = "http://youngstroke.org/Genius/KamiPHP/find_user.php";

            private final String mStart;

            RetrieveListingTask(String start) {
                mStart = start;
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                args.add(new BasicNameValuePair("start", mStart));
