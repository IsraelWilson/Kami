 ...
 */
public class ShortUserProfileActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = (EditText)findViewById(R.id.user_profile_username);
        zipcode = (EditText)findViewById(R.id.user_profile_zipcode);

        finish = (Button)findViewById(R.id.user_profile_finish);
        ...
        mProgressView = findViewById(R.id.user_profile_login_progress);
        mLoginFormView = findViewById(R.id.user_profile_login_form);
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(name, zip);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        private static final String login = "http://youngstroke.org/Genius/KamiPHP/create_user.php";

        private final String mUsername;
        private final String mZip;
        String message;

        UserLoginTask(String name, String zip) {
        ...
        protected String doInBackground(Void... params) {
            ...
            args.add(new BasicNameValuePair("zip", mZip));
